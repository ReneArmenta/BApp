    ...
    <div class="container d-flex h-100">
        ...
        <div id="login-form" class="row justify-content-center align-self-center w-100 form animated ">
            <div class="col-lg-6" id="login-form" style="float:left;">
                <img src="../Assets/img/Logo/beerapp_logo.png" id="logo">
                <h1>BeerApp</h1>
            ...
            <div class="col-lg-6" id="login-form" style="float:left;">
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <p class="new-account-text check_text">Soy mayor de edad</p>
                        </td>
                    </tr>
                    <tr>
                        <td><input type="checkbox" class="checkbox check_tc"></td>
                        <td>
                            <p class="new-account-text check_text">He leido los <a href="#" data-toggle="modal" data-target="#tc">terminos y condiciones</a></p>
                        </td>
                    </tr>
                </table>
